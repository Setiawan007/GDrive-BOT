...
def map(pos):
    if(pos==1):
        ...
        button = [
            [
             InlineKeyboardButton(text = 'Support Chat', url = "https://instagram.com/setiawan.007"),
             InlineKeyboardButton(text = 'Feature Request', url = "https://github.com/Setiawan007/GDrive-BOT")
            ],
